  ...
  useEffect(() => {
    const fetchPurchasedCourses = async () => {
      ...
      try {
        ...
        const ids = (response.data.courseData || []).map((c) => c._id);
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {courses.map((course) => (
                ...
                >
                  ...
                  {isLoggedIn && !purchasedCourseIds.includes(course._id) ? (
                    <Link
                      to={`/buy/${course._id}`}
                    ...
                    <div className="text-green-600 font-semibold text-center">Already Purchased</div>
                  ) : null}
                </div>
              ))}
            </div>
